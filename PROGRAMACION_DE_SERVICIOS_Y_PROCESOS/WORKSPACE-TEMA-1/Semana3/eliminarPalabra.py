...
palabraEliminada = input("Palabra a eliminar: ")

# Comprobar y eliminar todas las ocurrencias de las palabras
while palabraEliminada in listaPalabras:
    listaPalabras.remove(palabraEliminada)
