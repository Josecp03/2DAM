...
public class CrearBD {
	...
	public static void main(String[] args) {
		...
		Clientes cli1 = new Clientes(1, "Antonio Ruiz", "Talavera", 0);
		Clientes cli2 = new Clientes(2, "La Alameda S.L.", "Talavera", 1);
		Clientes cli3 = new Clientes(7, "Los molinos CB", "Madrid", 0);
		Clientes cli4 = new Clientes(8, "Pedro Mor�n S.L.", "Talavera", 0);
		Clientes cli5 = new Clientes(12, "Azulejos Mart�n S.L.", "Talavera", 1);
		Clientes cli6 = new Clientes(15, "Bar Girasol", "Oropesa", 0);
		Clientes cli7 = new Clientes(9, "Escuela Mayores", "Talavera", 1);
		Clientes cli8 = new Clientes(17, "Galer�a Madrid S.L.", "Madrid", 1);
		Clientes cli9 = new Clientes(19, "El corte Chino", "Talavera", 0);
		Clientes cli10 = new Clientes(20, "UNICAS S.A.", "Oropesa", 1);
		Clientes cli11 = new Clientes(21, "Deportivo SAS", "Talavera", 1);
		Clientes cli12 = new Clientes(22, "Academia Padel", "Madrid", 1);
		...
		// Hacer query
		IQuery CONSULTA = new
				  CriteriaQuery(Clientes.class, Where.equal("descuento", 1));

		Objects<Clientes> objects = odb.getObjects(CONSULTA);
		...
		for (Clientes c : objects) {
			...
			for (Articulos a : articulos) {
				...
				precioFinal = a.getPvp() - a.getDescuento();
				
									
			}

			Ventas v1 = new Ventas(1, ar1, cli1, 5, "05/06/2014", precioFinal);
			Ventas v2 = new Ventas(2, ar1, cli2, 4, "15/06/2014", precioFinal);
			Ventas v3 = new Ventas(3, ar1, cli6, 3, "25/06/2014", precioFinal);

			Ventas v4 = new Ventas(4, ar2, cli6, 5, "03/07/2014", precioFinal);
			Ventas v5 = new Ventas(5, ar2, cli7, 4, "11/08/2014", precioFinal);

			Ventas v6 = new Ventas(6, ar3, cli1, 3, "25/04/2014", precioFinal);
