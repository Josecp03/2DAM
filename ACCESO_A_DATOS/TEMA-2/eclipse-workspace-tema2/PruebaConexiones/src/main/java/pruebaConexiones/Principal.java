		...
		try {
			...
			do {
				...
				case 1:
					...
					conexion = DriverManager.getConnection("jdbc:mysql://localhost/EJEMPLO", "root", "dam");
				...
				case 3:
					...
					conexion = DriverManager.getConnection("jdbc:hsqldb:file:.\\basesDeDatos\\hsqldb\\data\\ejemplo\\ejemplo");
					consultadepartamentos(conexion);
					conexion.close();
					break;
				case 4:
