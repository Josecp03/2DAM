...
public class EditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Recoger los valores del intent
        ...
        // Escribir los datos anteriores
        edtNombre.setText(nombreIntent);
        edtCiudad.setText(ciudadIntent);
        edtEdad.setText(edadIntent);

        // Comprobar la preferencia
        if (preferenciaIntent.equals("Windows")) {
            rbWindows.setChecked(true);
        } else if (preferenciaIntent.equals("MacOs")) {
            rbMacOs.setChecked(true);
        }
        ...
        btnContinuar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!datosCorrectos(rbWindows, rbMacOs, nombre, ciudad, edad)) {
                    Toast.makeText(EditActivity.this, "Los campos no pueden estar vacíos", Toast.LENGTH_SHORT).show();
                } else {
